...
COLLECTION = "skala-2.4.17-strategy"
API_KEY = os.getenv("QDRANT_API_KEY", "Skala25a!23$")
HEADERS = {"api-key": API_KEY, "Content-Type": "application/json"}


def upsert_sample_point():
    # Deterministic example: first 5 dense values set, rest zero-filled to 1024 dims.
        ...
        "points": [
            {
                "id": 2,
                "vector": {
                    "strategy-dense-vector": dense_vector,
                    "strategy-sparse-vector": sparse_vector,
                },
                "payload": {"note": "curl/python insert test"},
            }
        ]
    }

...
class AppState(TypedDict, total=False):
    ...
    mapping: Optional[MappingResults]
    mapping_debug: Optional[MappingDebugInfo]

    strategy: Optional[StrategyResults]
    validation_strategy: Optional[bool]

    mapping_context: MappingContext

    impact_scores: List[ImpactScoreItem]
    report: Optional[ReportDraft]

...
| **BE1 – 백엔드 리드 (트랜잭션·API 게이트웨이)** | <img src="https://avatars.githubusercontent.com/DWECK" width=120px alt="조영우"/> [조영우](https://github.com/DWECK) | 전체 API 라우팅 / 트랜잭션 관리 / 서비스 orchestration |
